...
Core workflow and tool tiers (context-first vs compat-gated legacy): `docs/MCP_CORE_WORKFLOW.md`. Set `BLOP_ENABLE_COMPAT_TOOLS=true` only when you need `browser_*` / `blop_v2_*` parity tools.
