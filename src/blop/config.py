...
# Per-role LLM model overrides (empty = use BLOP_LLM_MODEL or provider default)
BLOP_AGENT_LLM_MODEL: str = os.getenv("BLOP_AGENT_LLM_MODEL", "")
BLOP_PLANNER_LLM_MODEL: str = os.getenv("BLOP_PLANNER_LLM_MODEL", "")
BLOP_REPAIR_LLM_MODEL: str = os.getenv("BLOP_REPAIR_LLM_MODEL", "")
BLOP_CLASSIFIER_LLM_MODEL: str = os.getenv("BLOP_CLASSIFIER_LLM_MODEL", "")
BLOP_VISION_LLM_MODEL: str = os.getenv("BLOP_VISION_LLM_MODEL", "")
# OTel tracing for LLM calls (set to 1/true to emit spans; requires blop-mcp[otel])
BLOP_OTEL_TRACING: str = os.getenv("BLOP_OTEL_TRACING", "")
# Secrets masking file (default: .blop/secrets.env); read at call-time in engine/secrets.py
...
BLOP_AUTH_VALIDATION_CACHE_TTL_SECS: float = float(os.getenv("BLOP_AUTH_VALIDATION_CACHE_TTL_SECS", "60"))
BLOP_ALLOW_ABSOLUTE_AUTH_PATHS: bool = _env_bool("BLOP_ALLOW_ABSOLUTE_AUTH_PATHS", False)
TEST_USERNAME_SELECTOR: str = os.getenv("TEST_USERNAME_SELECTOR", "")
TEST_PASSWORD_SELECTOR: str = os.getenv("TEST_PASSWORD_SELECTOR", "")
